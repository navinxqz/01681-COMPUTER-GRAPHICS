...
void drawEngland(float x1, float y1, float x2, float y2) {
...
void drawFinland(float x1, float y1, float x2, float y2) {
...
void drawItaly(float x1, float y1, float x2, float y2) {
...
void drawFrance(float x1, float y1, float x2, float y2) {
    drawRectangle(x1, y1, x1 + (x2 - x1) / 3, y2, 0.0f, 0.0f, 1.0f); // Blue
    drawRectangle(x1 + (x2 - x1) / 3, y1, x1 + 2 * (x2 - x1) / 3, y2, 1.0f, 1.0f, 1.0f); // White
    drawRectangle(x1 + 2 * (x2 - x1) / 3, y1, x2, y2, 1.0f, 0.0f, 0.0f); // Red
}

void drawGermany(float x1, float y1, float x2, float y2) {
...
void display() {
    ...
    drawEngland(-1.0f, -height / 2, -1.0f + width - spacing, height / 2);
    drawFinland(-1.0f + width + spacing, -height / 2, -1.0f + 2 * width - spacing, height / 2);
    drawItaly(-1.0f + 2 * width + spacing, -height / 2, -1.0f + 3 * width - spacing, height / 2);
    drawFrance(-1.0f + 3 * width + spacing, -height / 2, -1.0f + 4 * width - spacing, height / 2);
    drawGermany(-1.0f + 4 * width + spacing, -height / 2, 1.0f, height / 2);
